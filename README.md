...
- **Access Token**: Short-lived, signed P-256 ECDSA JSON Web Token (1 minute TTL) set as an `httpOnly`, `Secure` (in prod), same-site cookie. It is used to authorize stateless resource requests.
